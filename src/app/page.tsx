          ...
          >
            ...
            <div className="mx-auto grid max-w-md grid-cols-1 gap-y-6 px-4 sm:max-w-7xl sm:grid-cols-3 sm:gap-x-6 sm:gap-y-0 sm:px-6 lg:gap-x-8 lg:px-8">
              {collections.map((collection) => (
                <div
                  key={collection.name}
                  className="group relative h-96 rounded-lg  border-2 shadow-xl sm:aspect-h-5 sm:aspect-w-4 sm:h-auto"
                >
                  <div>
                    <div
                      aria-hidden="true"
                    ...
                    >
                      <div className="absolute inset-0 overflow-hidden group-hover:opacity-75 p-10">
                        <img
                    ...
                    <div className="absolute inset-0 flex items-end rounded-lg p-6">
                      <div>
                        ...
                        <h3 className="mt-1 font-semibold text-white">
                          ...
                          >
                            <span className="absolute inset-0 text-black dark:text-white" />
                            {collection.name}
                          </a>
                        </h3>
                      </div>
...
const collections = [
  ...
  },
  {
    name: "Etherium",
    href: "#",
    imageSrc: "https://cryptologos.cc/logos/ethereum-eth-logo.png?v=035",
    imageAlt:
